...
//	{
//		std::string vertexShaderSource = jlLib::loadShaderSourceFromFile(vertexShader.c_str());
//		std::string fragmentShaderSource = jlLib::loadShaderSourceFromFile(fragmentShader.c_str());
